...
@Autonomous
public class margarida extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        motorFrontLeft.setPower(0.87 * lim);
        motorBackLeft.setPower(-0.87 * lim);
        motorFrontRight.setPower(1.2 * lim);
        motorBackRight.setPower(1.2 * lim);
        Thread.sleep(450);

        motorFrontLeft.setPower(0.79 * lim);// anda para frente
        motorBackLeft.setPower(-0.79 * lim);
        motorFrontRight.setPower(-1 * lim);
        motorBackRight.setPower(-1 * lim);
        Thread.sleep(3400);
    }
}
